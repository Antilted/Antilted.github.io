...
hoverClickButton.addEventListener("click", function () {
  ...
  // we can change the url using the location.href attribute
  // find location
  console.log(location.href);
  // set the value of location : requires string value of html file name
  location.href = "flick.html";
});
...
dragDropButton.addEventListener("click", function () {
  ...
  // create delay variable : needs to be ms
  let delay = 1000;
  // use setTimeout to run JS after specify delay
  setTimeout(function () {
